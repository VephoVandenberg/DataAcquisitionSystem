#############################################################################
# Makefile for building: UniversityProject
# Generated by qmake (3.1) (Qt 5.12.8)
# Project:  UniversityProject.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile UniversityProject.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = UniversityProject1.0.0
DISTDIR = /home/vepho/Working/Projects/UniversityProject/.tmp/UniversityProject1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = app.cpp \
		src/GUI/HDDWidget.cpp moc_HDDWidget.cpp
OBJECTS       = app.o \
		HDDWidget.o \
		moc_HDDWidget.o
...
UniversityProject:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: UniversityProject.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/yacc.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		UniversityProject.pro
	$(QMAKE) -o Makefile UniversityProject.pro
...
all: Makefile UniversityProject
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/GUI/HDDWidget.h src/GUI/RAMWidget.h $(DISTDIR)/
	$(COPY_FILE) --parents app.cpp src/GUI/HDDWidget.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_HDDWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_HDDWidget.cpp
...
app.o: app.cpp src/GUI/HDDWidget.h \
		src/GUI/RAMWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o app.o app.cpp

HDDWidget.o: src/GUI/HDDWidget.cpp src/GUI/HDDWidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HDDWidget.o src/GUI/HDDWidget.cpp

moc_HDDWidget.o: moc_HDDWidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_HDDWidget.o moc_HDDWidget.cpp
